...
interface Order {
  ...
  items: OrderItem[]
  total: number
  status: 'pending' | 'payment_confirmed' | 'preparing' | 'ready' | 'completed'
...
const activeTab = ref<'produtos' | 'pedidos'>('produtos')
  ...
  <AppLayout>
    <div class="min-h-screen bg-gray-50">
      ...
      <div class="bg-white border-b">
        <div class="container mx-auto px-4">
          <div class="flex gap-8">
            ...
            <!-- Nova aba Pedidos (só para o dono) -->
            <button
              v-if="isOwner"
      ...
      <div class="container mx-auto px-4 py-8">
        ...
        <!-- ABA DE PEDIDOS -->
        <div v-show="activeTab === 'pedidos'" v-if="isOwner">
          <h2 class="text-2xl font-bold text-gray-800 mb-6">Gerenciar Pedidos</h2>
          ...
          <div class="text-center py-16">
            ...
            <p class="text-gray-500 text-lg mb-2">Nenhum pedido recebido ainda</p>
            <p class="text-gray-400 text-sm">Os pedidos aparecerão aqui quando os clientes fizerem compras</p>
          </div>
        </div>
      </div>
    </div>
